...
- **Categorical Features:** `Sex` (M/F), `ChestPainType` (TA, ATA, NAP, ASY), `RestingECG`, `ExerciseAngina`, `ST_Slope`
...
_Note: Logistic Regression yielded the highest overall performance for this specific medical dataset layout._
...
````bash
git clone [https://github.com/amirsohail100/Hard-Disk-Speed-Prediction-Model.git](# Heart Disease Prediction Model 🫀🚀
